...
def get_DJT(q):
    ...
    for i in range(N_alpha):
        ...
        for k in range(N_q):
            ...
            s = i_theta
            D_jmmu = WignerD(sp.Rational(j), sp.Rational(m) , sp.Rational(mu), phi[i_phi], theta[i_theta], psi[i_psi]).doit()
...
def get_norm2(v):
    ...
    return norm2[0,0] ## only component of (1,1) array
####

# normalized columns vector that is the discrete version of the eigenstate of the continuum manifold
